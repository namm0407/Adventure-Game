# first level is a 8x8 board
# second level is a 10x10 board
#make sure they don't hit the bomb the first time

# 2 boards, 1 that is printed, 1 that is the solution
import time
import random
import sys
# generates the levels as empty 2d lists with 0s 
level = [[0]*10 for i in range(10)] # 20 bombs
displaylevel = [['🌴']*10 for i in range(10)]
